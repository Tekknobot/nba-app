...
// OPTIONAL (looks great, but not required):
// npm i @fontsource/courier-prime
...
export default function HaikuOfTheDay({
  ...
  compact = false,
  look = "typewriter", // default changed to typewriter
}) {
  ...
  // Typewriter/mono stack (Courier Prime if you enabled the import, else system monos)
  const typewriterStack = `"Courier Prime", ui-monospace, SFMono-Regular, Menlo, Consolas, "Liberation Mono", "Courier New", monospace`;
  ...
  const poemSx =
    look === "typewriter"
      ? {
          ...
          fontSize: { xs: compact ? 15 : 17, sm: compact ? 16 : 18 },
          lineHeight: compact ? 1.4 : 1.55,
        }
      : {
          // fallback serif option if you ever switch look="serif"
